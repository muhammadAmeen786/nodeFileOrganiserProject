...
function organize(srcPath) {
  ...
  if (srcPath == undefined) {
    ...
    srcPath = process.cwd();
     // if src path is not provided then our source path would be 
  ...
  if (fs.existsSync(organizedFiles) == false) {
                             // here we check if the folder is already present or not.
                             // should we make some changes i.e make the folder or not.
...
// let srcPath="/Users/ameen/Desktop/Desktop/ameendar//Node/fileOrganizer/downloads"
// organize(srcPath);
